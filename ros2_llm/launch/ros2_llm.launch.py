...
from launch.conditions import IfCondition  # Correct import for conditional launch
...
def generate_launch_description():
    ...
    # Create the webcam_vlm_node with conditional launch
    webcam_vlm_node = Node(
        package='ros2_llm',  # Replace with your actual package name
        executable='webcam_vlm_node',
        name='webcam_vlm_node',
        output='screen',
        condition=IfCondition(LaunchConfiguration('run_webcam_node'))  # Use IfCondition
    )
